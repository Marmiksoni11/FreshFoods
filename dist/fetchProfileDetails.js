...
if (authToken) {
    ...
    fetch('https://https://fresh-food-flame.vercel.app/api/v1/profile/update-avatar', {
        method: 'GET',
        headers: {
...
if (authToken) {
    // Fetch user details using the authentication token
    fetch('https://https://fresh-food-flame.vercel.app/api/v1/profile/update-cover-image', {
        method: 'GET',
        headers: {
